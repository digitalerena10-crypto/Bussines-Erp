    ...
    return (
        <div className="p-4 md:p-8 max-w-5xl mx-auto space-y-6 md:space-y-8 animate-fadeIn">
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-2xl md:text-3xl font-black text-gray-900 tracking-tight">Edit Sales Order</h1>
                    <p className="text-sm md:text-base text-gray-500 font-medium mt-1">Update the details of an existing sales order.</p>
                </div>
            </div>
